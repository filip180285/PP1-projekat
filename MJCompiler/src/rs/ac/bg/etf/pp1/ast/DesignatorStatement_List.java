...
public class DesignatorStatement_List extends DesignatorStatement {

    private DesignatorStatementList DesignatorStatementList;
    private Designator Designator;

    public DesignatorStatement_List (DesignatorStatementList DesignatorStatementList, Designator Designator) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatement_List(\n");
