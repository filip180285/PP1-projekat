...
public class StatementList_LABEL extends StatementList {

    private StatementList StatementList;
    private Label Label;
    private Statement Statement;

    public StatementList_LABEL (StatementList StatementList, Label Label, Statement Statement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementList_LABEL(\n");
