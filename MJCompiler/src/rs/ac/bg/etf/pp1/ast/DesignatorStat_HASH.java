...
public class DesignatorStat_HASH extends DesignatorStatement {

    private Factor Factor;
    private DesignatorArrayOrMatrixName DesignatorArrayOrMatrixName;

    public DesignatorStat_HASH (Factor Factor, DesignatorArrayOrMatrixName DesignatorArrayOrMatrixName) {
        this.Factor=Factor;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStat_HASH(\n");
